...
import Indicacoes from "./pagIndicacoes/indicacoes";
    ...
    <>
      <div className="main-container">
        <div className="image-container">
          ...
          <p className="text-white text-2xl font-extrabold italic w-550  z-index 100" style={{ top: "0" }}>
          Bem-vindos ao EducaBullying:
            </p>
            <p className="text-white text-xl font-bold italic w-150 z-index 100" style={{ top: "0" }}>
        ...
        <div className={styles.buttons}>
          ...
          <Link href="/quiz">
            <p className={styles.botao}>Ir para o Quiz</p>
          </Link>
        </div>
      </div>
